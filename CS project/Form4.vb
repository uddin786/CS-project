Public Class Form4
    ...
    Public Sub AI()
        Dim pick As Integer = CInt(Int((32 * Rnd()) + 1)) ' this ensures a  random integer from 1 to 32
        If pick = 1 Then
        ...
        ElseIf pick = 12 Then
            ...
            P37.Tag = "g.png"
        ElseIf pick = 13 Then
            P42.Image = Image.FromFile("g.png")
            P42.Tag = "g.png"
        ElseIf pick = 14 Then
        ...
        ElseIf pick = 23 Then
            ...
            ElseIf P66.Tag = "g.png" Then ' normal piece
                If P75.Tag = String.Empty Then
                    ...
                    P75.Tag = "g.png"
                ElseIf P77.Tag = String.Empty Then
                    P66.Image = Nothing
                    P66.Tag = String.Empty
                    P77.Image = Image.FromFile("g.png")
                    P77.Tag = "g.png"
                ElseIf P75.Tag = "g.png" Then
                    AI()
                ElseIf P75.Tag = "gk.png" Then
                    AI()
                ElseIf P77.Tag = "g.png" Then
                    AI()
            ...
            ElseIf P66.Tag = "gk.png" Then ' king piece
                If P75.Tag = String.Empty Then
                    P66.Image = Nothing
                    P66.Tag = String.Empty
                    P75.Image = Image.FromFile("gk.png")
                    P75.Tag = "gk.png"
                ElseIf P77.Tag = String.Empty Then
                    P66.Image = Nothing
                    P66.Tag = String.Empty
                    P77.Image = Image.FromFile("gk.png")
                    P77.Tag = "gk.png"
                ElseIf P55.Tag = String.Empty Then
                    P66.Image = Nothing
                    P66.Tag = String.Empty
        ...
        ElseIf pick = 28 Then
            ...
            P77.Tag = "g.png"
        ElseIf pick = 29 Then
            P82.Image = Image.FromFile("g.png")
            P82.Tag = "g.png"
        ElseIf pick = 30 Then
            P84.Image = Image.FromFile("g.png")
            P84.Tag = "g.png"
